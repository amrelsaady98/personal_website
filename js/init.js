...
jQuery(document).ready(function(){
	...
	kura_tm_color_switcher();
	kura_tm_switcher_opener();
	kura_tm_cursor_switcher();
	kura_tm_nav_bg();
...
function kura_tm_color_switcher(){

	"use strict";

	var list	= jQuery('.kura_tm_settings .colors li a');

	list.on('click',function(){
		var element = jQuery(this);
		var elval	= element.attr('class');
		element.closest('.kura_tm_all_wrap').attr('data-color',''+elval+'');
		return false;
	});	
}

function kura_tm_switcher_opener(){

	"use strict";

	var settings	= jQuery('.kura_tm_settings');
	...
	button.on('click',function(){
		...
		if(element.hasClass('opened')){
			...
			element.closest('.kura_tm_settings').removeClass('opened');
		}else{
			element.addClass('opened');
			element.closest('.kura_tm_settings').addClass('opened');
		}
		return false;
	});
	...
	dark.on('click',function(){
		...
		jQuery('.kura_tm_partners').addClass('opened');
		el.closest('.kura_tm_settings').addClass('changed');
		return false;
	});
	...
	light.on('click',function(){
		...
		jQuery('.kura_tm_partners').removeClass('opened');
		ele.closest('.kura_tm_settings').removeClass('changed');
		return false;
	});
}

function kura_tm_cursor_switcher(){

	"use strict";

	var wrapper		= jQuery('.kura_tm_all_wrap');
	var button		= jQuery('.kura_tm_settings .cursor li a');
	var show		= jQuery('.kura_tm_settings .cursor li a.show');
	var hide		= jQuery('.kura_tm_settings .cursor li a.hide');
